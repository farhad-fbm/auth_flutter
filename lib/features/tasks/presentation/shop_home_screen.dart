...
import 'package:uione/features/tasks/presentation/task_model.dart';
...
class _ShopHomeScreenState extends State<ShopHomeScreen> {
  final List<String> categoriesTemp = ["All", "Cleaning", "Errands", "Health & Self-Care"];

  String selectedCategory = "All";

  final List<Task> allTasksT = [
    Task(title: "Vacuum Living Room", category: "Cleaning", frequency: "DAILY", isToday: true),
    Task(title: "Pick up groceries", category: "Errands", frequency: "WEEKLY - SAT", isToday: true),
    Task(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          context.push('/shop_home/add_task');
        },
